...
function Index() {
  ...
  // გაყიდვების როლისთვის მარჟა ითვლება სხვა ბაზით: ჯამური ფასნამატი / გასაყიდი ფასი დღგ-ს ჩათვლით
  // (ფინანსების როლი კი ხედავს არსებულ ფორმულას — ფასნამატი / ფასი დღგ-ს გარეშე)
